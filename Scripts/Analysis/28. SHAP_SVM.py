...
def svm_shap():
    ...
    model = SVC(C=0.05, gamma=1.0, probability=True, random_state=42)
    ...
    shap_values_raw = explainer.shap_values(X_test_slice)
    ...
    output_path = os.path.join(REPORTS_DIR, "D1_SHAP_SMOTETomek_SVM.png")
